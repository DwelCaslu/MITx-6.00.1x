...
WORDLIST_FILENAME = "/Users/krisbauman/Desktop/edX Homework/6.00.1x/ProblemSet4/words.txt"
...
def playHand(hand, wordList, n):
    ...
    * The hand finishes when there are no more unused letters or the user
    ...
    while n != 0:
        ...
        (displayHand(hand))
        # Ask user for input
        wordIn = raw_input('Enter word, or a "." to indicate that you are finished: ')
        word = wordIn.lower()
